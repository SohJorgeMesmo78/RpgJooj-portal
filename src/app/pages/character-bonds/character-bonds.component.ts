  ...
  template: `
    <div class="wip-page-container animate-fade-in">
      ...
      <div class="wip-card medieval-card">
        ...
        <h1>Laços e Intriga</h1>
        <div class="card-divider"></div>
        <p class="wip-text">
          As relações, contatos, rivais, alianças e segredos deste herói estão sendo organizados no tomo da campanha.
        </p>
        <div class="card-wip-notice">
          <span class="wip-badge-mini">Em construção</span> Conteúdo em breve.
        </div>
      </div>
    </div>
  `,
